<nav class="navbar navbar-dark bg-black">
    <div class="container-fluid p-3 ps-5">
        <a class="navbar-brand"><h2><img src="/images/face-mask.png" height="75px" width="75px" class="pe-2">COVIDGuide
            </h2></a>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-md-5 col-6 col-sm-8 order-md-last text-center">
                <div class="row">
                    <div class="col-12 col-md-10"><img alt="image"
                                                       src="images/safety.svg" height="500px">
                    </div>
                </div>
            </div>
